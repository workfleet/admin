...
const styles = StyleSheet.create({
  // Bottom padding clears the two-line fixed footer.
  page: { paddingTop: 44, paddingBottom: 58, paddingHorizontal: 48, fontSize: 10, fontFamily: 'Helvetica', color: INK, lineHeight: 1.4 },

  footer: { position: 'absolute', bottom: 24, left: 48, right: 48, borderTopWidth: 1, borderTopColor: RULE, paddingTop: 6 },
  footerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  footerLeft: { fontSize: 7.5, color: FAINT },
  footerCredit: { flexDirection: 'row', alignItems: 'center' },
  footerCreditText: { fontSize: 6.5, color: FAINT, marginLeft: 3 },
  footerPage: { fontSize: 7.5, color: FAINT },
  footerLegal: { fontSize: 6.5, color: FAINT, flex: 1, paddingRight: 8 },

  eyebrow: { fontSize: 9, letterSpacing: 3, color: COMPANY.brandColor, fontFamily: 'Helvetica-Bold' },
  docTitle: { fontSize: 20, fontFamily: 'Helvetica-Bold', marginTop: 6 },
  docSubtitle: { fontSize: 12, color: MUTED, marginTop: 2 },
  titleRule: { borderBottomWidth: 2, borderBottomColor: COMPANY.brandColor, marginTop: 11, marginBottom: 11, width: 64 },
  ...
  kvBox: { backgroundColor: '#f6fafa', borderLeftWidth: 2, borderLeftColor: COMPANY.brandColor, paddingVertical: 7, paddingHorizontal: 11, marginBottom: 8 },
  kvRow: { flexDirection: 'row', marginBottom: 2.5 },
  kvLabel: { width: 130, color: MUTED },
  kvValue: { flex: 1 },

  priceBox: { backgroundColor: '#f0fdfd', borderRadius: 6, padding: 11, marginBottom: 10, alignItems: 'center' },
  priceLabel: { fontSize: 9, letterSpacing: 1, color: MUTED, textTransform: 'uppercase' },
  priceValue: { fontSize: 23, fontFamily: 'Helvetica-Bold', color: COMPANY.brandColor, marginTop: 3 },
  ...
  closing: { marginTop: 4, alignItems: 'center' },
