...
// input shape:
// {
//   serviceType: 'cleaning' | 'gardening',
...
//   // gardening only:
//   gardenSize,
//   // both (different catalogs - see ADDON_TYPES / GARDEN_ADDON_TYPES):
...
export function calculateQuote(input, settings) {
  ...
  const oven = isGardening ? OVEN_OPTIONS.none : (OVEN_OPTIONS[input.oven] || OVEN_OPTIONS.none);
