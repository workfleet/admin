      ...
      <div className="card">
        ...
        {checkin && (
          <p style={{ fontSize: 14 }}>
            ...
            {checkin.checked_out_at && checkin.auto_checked_out && (
              <span style={{ color: 'var(--muted)' }}> (automatic – you left the property)</span>
            )}
          </p>
        )}
        {resumable && (
          <>
            <p style={{ fontSize: 13, color: 'var(--muted)', margin: '6px 0 10px' }}>
              You were checked out automatically because you left the property. Still here? Check
              back in and carry on - your photos and tasks are as you left them.
            </p>
            <button onClick={handleResume} disabled={resuming} title="Undo the automatic check-out and carry on with this job">
